...
//        });
    ...
    public void afficher() {
        ...
        nomsJoueurs.get(0).setText("Test");
        nomsJoueurs.get(1).setText("Test");
        nomsJoueurs.get(2).setText("Test");
        nomsJoueurs.get(3).setText("Test");
        couleursJoueurs.get(0).setSelectedIndex(4);
        couleursJoueurs.get(1).setSelectedIndex(1);
        couleursJoueurs.get(2).setSelectedIndex(2);
        couleursJoueurs.get(3).setSelectedIndex(3);
