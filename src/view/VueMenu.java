...
public class VueMenu implements Observe {
    ...
    public VueMenu() {
        ...
        menuWindow.setLocation(Parameters.HORIZONTAL_BUFFER*35, Parameters.VERTICAL_BUFFER*2 - Parameters.TASKBAR_BUFFER);
        ...
        for (JTextField nom : nomsJoueurs) {
            ...
            public void keyTyped(KeyEvent e) {
                if (nom.getText().length() >= 17 ) // limite à 17 caractères
                    e.consume();
                }
            });
        }
